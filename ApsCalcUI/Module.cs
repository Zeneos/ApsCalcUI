...
namespace ApsCalcUI
{
    public class Module
    {
        ...
        public static Module EmpHead { get; } = new Module("EMP head", 1.45f, 1.0f, 1.0f, 1.0f, 500, Position.Head, false);
        public static Module FlaKHead { get; } = new Module("FlaK head", 1.45f, 1.0f, 0.1f, 1.0f, 500, Position.Head, false);
        public static Module FragHead { get; } = new Module("Frag head", 1.45f, 1.0f, 1.0f, 1.0f, 500, Position.Head, false);
        public static Module HEHead { get; } = new Module("HE head", 1.45f, 1.0f, 1.0f, 1.0f, 500, Position.Head, false);
        ...
        public static Module HollowPoint { get; } = new Module("Hollow point head", 1.45f, 1.0f, 1.2f, 1.0f, 500, Position.Head, false);
