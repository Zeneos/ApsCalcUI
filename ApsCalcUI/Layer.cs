namespace ApsCalcUI
{
    public class Layer
    {
        ...
        public static Layer WoodBeam { get; } = new Layer("Wood 4m Beam", 960f, 8f, true, 0f);
        ...
        public static Layer WoodBeamSlope { get; } = new Layer("Wood Beam Slope", 480f, 8f, false, 45f);
        ...
        public static Layer Wood2mSlopeSteep { get; } = new Layer("Wood 2m Slope (steep)", 220f, 8f, false, 26.56505f);
        ...
        public static Layer Wood2mSlopeShallow { get; } = new Layer("Wood 2m Slope (shallow)", 220f, 8f, false, 63.43495f);
        ...
        public static Layer Wood3mSlopeSteep { get; } = new Layer("Wood 3m Slope (steep)", 345f, 8f, false, 18.43495f);
        ...
        public static Layer Wood3mSlopeShallow { get; } = new Layer("Wood 3m Slope (shallow)", 345f, 8f, false, 71.56505f);
        ...
        public static Layer Wood4mSlopeSteep { get; } = new Layer("Wood 4m Slope (steep)", 480f, 8f, false, 14.03624f);
        ...
        public static Layer Wood4mSlopeShallow { get; } = new Layer("Wood 4m Slope (shallow)", 480f, 8f, false, 75.96376f);
        ...
        public static Layer WoodWedgeSteep { get; } = new Layer("Wood Wedge (steep)", 100f, 8f, false, 26.56505f);
        ...
        public static Layer WoodWedgeShallow { get; } = new Layer("Wood Wedge (shallow)", 100f, 8f, false, 63.43495f);
        ...
        public static Layer Wood2mWedgeSteep { get; } = new Layer("Wood 2m Wedge (steep)", 220f, 8f, false, 14.03624f);
        ...
        public static Layer Wood2mWedgeShallow { get; } = new Layer("Wood 2m Wedge (shallow)", 220f, 8f, false, 75.96376f);
        ...
        public static Layer Wood3mWedgeSteep { get; } = new Layer("Wood 3m Wedge (steep)", 345f, 8f, false, 9.46232f);
        ...
        public static Layer Wood3mWedgeShallow { get; } = new Layer("Wood 3m Wedge (shallow)", 345f, 8f, false, 80.53768f);
        ...
        public static Layer Wood4mWedgeSteep { get; } = new Layer("Wood 4m Wedge (steep)", 480f, 8f, false, 7.12502f);
        ...
        public static Layer Wood4mWedgeShallow { get; } = new Layer("Wood 4m Wedge (shallow)", 480f, 8f, false, 82.87498f);
